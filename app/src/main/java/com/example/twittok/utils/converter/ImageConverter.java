...
public class ImageConverter {
    ...
    private static final String TAG = "IMAGE_CONVERTER";
    ...
    private static Bitmap base64ToBitmap(String base){
    ...
    public static Bitmap convertImageToBitmap(String base64Image){
        try{
            return base64ToBitmap(base64Image);
        }catch(NullPointerException | IllegalArgumentException e){
            Log.d(TAG, "checkImageVersion: user " + base64Image + " has wrong image format");
            return base64ToBitmap(PLACEHOLDER);
        }
    }
    public static String convertImageToBase64(Bitmap bitmapImage){
        try{
            return bitmapToBase64(bitmapImage);
        }catch(NullPointerException | IllegalArgumentException e){
            Log.d(TAG, "checkImageVersion: conversion went wrong");
            return PLACEHOLDER;
        }
    }
}
